...
class BioeconomicModel:
    ...
    def generate_report(self):
        ...
        df.to_csv(f'{output_dir}/simulation_results_v2.csv', index=False)
    ...
    def plot_results(self):
        ...
        plt.ylabel('Price')
        plt.legend()
        plt.savefig(f'{output_dir}/market_prices_v2.png')
        plt.close()
        ...
        plt.legend()
        plt.savefig(f'{output_dir}/environmental_conditions_v2.png')
        plt.close()
        ...
        plt.legend()
        plt.savefig(f'{output_dir}/agent_performances_v2.png')
        plt.close()
